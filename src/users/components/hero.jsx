    ...
    return (
        ...
        <div class="hero position-relative overflow-hidden p-3 p-md-5 text-center bg-light">
            <div class="col-md-5 p-lg-5 mx-auto my-5">
                ...
                <button type="button" class="btn btn-primary primary-color text-uppercase m-5" onClick={() => setShow(!show)}>Daftar vaksinasi sekarang!</button>
                <ModalCheckStatus show={show} setShow={setShow}/>
            </div>
