    ...
    return (
        ...
        <div class="mx-auto d-flex flex-column flex-shrink-0 p-3 card shadow-sm" style={{"width": "280px"}}>
            {/* <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none"> */}
                <span class="fs-4"><i class="fas fa-user mx-3"></i>Andi Pratama</span>
            {/* </a> */}
            <hr></hr>
            <ul class="nav nav-pills flex-column mb-auto">
            <li class="nav-item">
                <NavLink to='/dashboard/profil' className="my-0 py-2 px-3 text-decoration-none" 
                    style={({ isActive }) => {
                        return {
                          display: "block",
                          margin: "1rem 0",
                    ...
                    aria-current="page">Profil Saya</NavLink>
            ...
            <li>
                <NavLink to='/dashboard/edit-password' className="my-0 py-2 px-3 text-decoration-none" 
                    style={({ isActive }) => {
                        return {
                          display: "block",
                          margin: "1rem 0",
                    ...
                    aria-current="page">Lupa Password</NavLink>
            ...
            <li>
                <NavLink to='/dashboard/tiket' className="my-0 py-2 px-3 text-decoration-none" 
                    style={({ isActive }) => {
                        return {
                          display: "block",
                          margin: "1rem 0",
                    ...
                    aria-current="page">Tiket Vaksin</NavLink>
                {/* <a href="#" class="nav-link link-dark"> */}
