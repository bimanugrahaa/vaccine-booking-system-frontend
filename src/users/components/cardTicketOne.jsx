...
export default function CardTicketOne(props) {
        ...
        <div className="container-fluid mx-auto mb-3">
            <div className="card border-3 p-4">
                ...
                {status === "Sudah Vaksin" || status === "Terdaftar"? 
                    <>
                    <h5 className="my-3 fw-bold text-success">Vaksin Pertama</h5>
                    </>
                :
                    <>
                    <h5 className="my-3 fw-bold text-secondary">Vaksin Pertama</h5>
                    </>
                }
                {status === "Expired"?
                <>
                    <h6 className="text-center text-danger">Tiket vaksin expired. Silakan melakukan pendaftaran ulang</h6>
                </>
                :
                ""
                }
